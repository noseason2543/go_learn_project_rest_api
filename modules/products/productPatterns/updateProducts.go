...
type updateProductBuilder struct {
	...
	filesUsecases  fileUsecases.IFileUsecases
	query          string
	queryFields    []string
	lastStackIndex int
	values         []any
...
func UpdateProductBuilder(db *sqlx.DB, req *products.Product, filesUsecases fileUsecases.IFileUsecases) IUpdateProductBuilder {
